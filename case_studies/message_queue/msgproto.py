"""Define message protocol, Since TCP is not message-based protocol."""
from asyncio import StreamReader, StreamWriter

"""
    Message format:
    |---size_bytes---|------data of size mentioned in size_bytes-----|
    
    We pass size of data in first 4 bytes and then the data.
"""
